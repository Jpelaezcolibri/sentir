...
const COLOR_MAP: { [key: string]: { hex: string; isDark: boolean } } = {
  negro: { hex: "#2a2a2a", isDark: true },
  blanco: { hex: "#fafafa", isDark: false },
  "blanco hueso": { hex: "#f5f1ed", isDark: false },
  crema: { hex: "#faf6f1", isDark: false },
  beige: { hex: "#e8ddd0", isDark: false },
  arena: { hex: "#e0d4c4", isDark: false },
  nude: { hex: "#e8d4c4", isDark: false },
  champagne: { hex: "#f5e6d3", isDark: false },
  "palo de rosa": { hex: "#f0d9dd", isDark: false },
  rosa: { hex: "#f0d9dd", isDark: false },
  "rosa pastel": { hex: "#ffd4e5", isDark: false },
  rojo: { hex: "#e8a3ad", isDark: false },
  "rojo vino": { hex: "#d4a5a5", isDark: false },
  azul: { hex: "#c4d9e8", isDark: false },
  "azul marino": { hex: "#b8ccde", isDark: false },
  verde: { hex: "#c4d9b0", isDark: false },
  "verde oliva": { hex: "#d4d0a0", isDark: false },
  "verde antioquia": { hex: "#cad9b8", isDark: false },
  gris: { hex: "#d0d0d0", isDark: false },
  "gris claro": { hex: "#e8e8e8", isDark: false },
  amarillo: { hex: "#f5e8c4", isDark: false },
  oro: { hex: "#f5e8c4", isDark: false },
  naranja: { hex: "#f0d9c4", isDark: false },
  lila: { hex: "#e0d4e8", isDark: false },
  purpura: { hex: "#d9c4e0", isDark: false },
  morado: { hex: "#dcc4e8", isDark: false },
